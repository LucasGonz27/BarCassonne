...
### **Types de tours**
- **Tour Archer** : Cadence rapide, dégâts modérés, idéale pour les ennemis faibles
- **Tour Magique** : Attaques magiques rapides, efficace contre les ennemis résistants
- **Tour Canon** : Dégâts très élevés, cadence lente, parfaite pour les boss
- **Tour Forgeron** : Génère des lingots passivement pour améliorer votre économie
...
### **1. Cloner le projet**
```bash
git clone https://github.com/votre-repo/T-JAV-501-MPL_5.git
cd T-JAV-501-MPL_5
```
...
- **Fonction** : Génère des lingots passivement
...
- **Théo Baixeras** - [@Baixerastheo](https://github.com/Baixerastheo)
- **Lucas Gonzalez** - [@LucasGonz27](https://github.com/LucasGonz27)
- **Samuel Baptista** - [@Samuel-Baptista](https://github.com/Samuel-Baptista)
